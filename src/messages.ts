...
export const LOSE_MESSAGES: LoseMessage[] = [
    ...
    ["Psst... have you tried ULTRA yet?", (state, stats, difficulty) => difficulty.index < 4 && state.lastHurtBy !== HitType.HitLock],
    ...
    ["I believe in you...<br/><br/>continuing to dying a lot.", (state, stats, difficulty) => difficulty.index >= 4],
    ...
    ["What are you after, bragging rights?", (state, stats, difficulty) => difficulty.index >= 4],
]
