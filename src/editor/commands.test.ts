...
describe('commands', () => {
  ...
  describe('SetAppleCommand', () => {
    it('should set apples and unset barriers', () => {
      ...
      const command = new SetAppleCommand(10, 10, data, setData);
    ...
    it('should set apples and unset decoratives1', () => {
      ...
      const command = new SetAppleCommand(11, 11, data, setData);
      const res = command.execute();
      expect(res).toEqual(true);
    ...
    it('should set and unset multiple cells', () => {
      ...
      const commands = [
        new SetBarrierCommand(1, 1, data, setData),
        new SetBarrierCommand(2, 2, data, setData),
        new SetBarrierCommand(3, 3, data, setData),
        new SetBarrierCommand(4, 4, data, setData),
        new SetAppleCommand(5, 5, data, setData),
        new SetAppleCommand(6, 6, data, setData),
        new SetAppleCommand(7, 7, data, setData),
        new SetAppleCommand(8, 8, data, setData),
        new SetDecorative1Command(9, 9, data, setData),
        new SetDecorative1Command(10, 10, data, setData),
        new SetDecorative1Command(11, 11, data, setData),
        new SetDecorative1Command(12, 12, data, setData),
      ];
  ...
  describe('SetBarriersCommand', () => {
    it('should set barriers and unset portals', () => {
      ...
      const command = new SetBarrierCommand(25, 25, data, setData);
      const res = command.execute();
      expect(res).toEqual(true);
  ...
  describe('SetNospawnCommand', () => {
    it('should set nospawn', () => {
      ...
      const command = new SetNospawnCommand(55, 55, editorData, setData);
      const res = command.execute();
      expect(res).toEqual(true);
    ...
    it('should ignore if elements already set', () => {
      ...
      const commands = [
        new SetNospawnCommand(1, 1, data, setData),
        new SetNospawnCommand(2, 2, data, setData),
        new SetNospawnCommand(3, 3, data, setData),
        new SetNospawnCommand(4, 4, data, setData),
        new SetNospawnCommand(5, 5, data, setData),
        new SetNospawnCommand(6, 6, data, setData),
      ];
      const results = commands.map(command => command.execute());
  ...
  describe('SetPassableCommand', () => {
    it('should set passable if barrier exists at location', () => {
      ...
      const command = new SetPassableCommand(5, 5, data, setData);
      const res = command.execute();
      expect(res).toEqual(true);
    ...
    it('should set multiple cells', () => {
      ...
      const commands = [
        new SetPassableCommand(5, 5, data, setData),
        new SetPassableCommand(10, 10, data, setData),
        new SetPassableCommand(15, 15, data, setData),
      ];
      const results = commands.map(command => command.execute());
  ...
  describe('SetKeyCommand', () => {
    it('should set key at location', () => {
      ...
      const command = new SetKeyCommand(5, 5, KeyChannel.Blue, data, setData);
      const res = command.execute();
      expect(res).toEqual(true);
    ...
    it('should not set if already set with same channel', () => {
      ...
      const command = new SetKeyCommand(5, 5, KeyChannel.Red, data, setData);
      const res = command.execute();
      expect(res).toEqual(false);
