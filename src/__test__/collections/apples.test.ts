...
describe("Collections", () => {
  describe("Apples", () => {
    ...
    it("should get closest traversal distance", () => {
      ...
      apples.add(4, 4);
      apples.add(5, 5);
      assert(apples.getClosestTraversalDistance(0, 0) === 2);
      assert(apples.getClosestTraversalDistance(0, 1) === 1);
      assert(apples.getClosestTraversalDistance(1, 1) === 0);
      assert(apples.getClosestTraversalDistance(2, 2) === 0);
      assert(apples.getClosestTraversalDistance(3, 3) === 0);
      assert(apples.getClosestTraversalDistance(4, 4) === 0);
      assert(apples.getClosestTraversalDistance(5, 5) === 0);
      assert(apples.getClosestTraversalDistance(5, 6) === 1);
      assert(apples.getClosestTraversalDistance(6, 6) === 2);
      assert(apples.getClosestTraversalDistance(6, 7) === 3);
      assert(apples.getClosestTraversalDistance(7, 7) === 4);
      assert(apples.getClosestTraversalDistance(15, 15) === 20);
      apples.removeByCoord(getCoordIndex2(1, 1));
      apples.removeByCoord(getCoordIndex2(2, 2));
      apples.removeByCoord(getCoordIndex2(3, 3));
      apples.removeByCoord(getCoordIndex2(4, 4));
      assert(apples.getClosestTraversalDistance(0, 0) === 10);
      assert(apples.getClosestTraversalDistance(1, 1) === 8);
      assert(apples.getClosestTraversalDistance(2, 2) === 6);
      assert(apples.getClosestTraversalDistance(3, 3) === 4);
      assert(apples.getClosestTraversalDistance(4, 4) === 2);
      assert(apples.getClosestTraversalDistance(5, 5) === 0);
      assert(apples.getClosestTraversalDistance(15, 15) === 20);
      apples.removeByCoord(getCoordIndex2(5, 5));
      assert(apples.getClosestTraversalDistance(0, 0) === Infinity);
      assert(apples.getClosestTraversalDistance(1, 1) === Infinity);
      assert(apples.getClosestTraversalDistance(2, 2) === Infinity);
      assert(apples.getClosestTraversalDistance(3, 3) === Infinity);
      assert(apples.getClosestTraversalDistance(4, 4) === Infinity);
      assert(apples.getClosestTraversalDistance(5, 5) === Infinity);
      assert(apples.getClosestTraversalDistance(6, 6) === Infinity);
      assert(apples.getClosestTraversalDistance(6, 7) === Infinity);
      assert(apples.getClosestTraversalDistance(7, 7) === Infinity);
      assert(apples.getClosestTraversalDistance(15, 15) === Infinity);
    })
  });
});
