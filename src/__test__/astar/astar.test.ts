  ...
  describe("AStar", () => {
    ...
    describe("Search", () => {
      ...
      it("should search and avoid mine threats", () => {
        ...
        const astar = new AStar({ threats: mines });
        mines.add(3, 3, 999999, Image.MineSheet);
        mines.add(2, 5, 999999, Image.MineSheet);
        mines.add(0, 6, 999999, Image.MineSheet);
        mines.add(6, 0, 999999, Image.MineSheet);
        mines.add(9, 9, 999999, Image.MineSheet);
        mines.add(6, 12, 999999, Image.MineSheet);
        mines.add(12, 6, 999999, Image.MineSheet);
        mines.add(15, 3, 999999, Image.MineSheet);
        mines.add(15, 2, 999999, Image.MineSheet);
        mines.add(15, 1, 999999, Image.MineSheet);
        mines.add(3, 20, 999999, Image.MineSheet);
        mines.add(28, 20, 999999, Image.MineSheet);
        const result = astar.search(1, 1, 28, 28);
        if (DEBUG) astar.debugPrint();
        assert(result);
        const path = astar.test__getPath();
      ...
      it("should search and avoid mine threats with diagonals", () => {
        const mines = new AnimationList();
        const astar = new AStar({ threats: mines, allowDiagonals: true });
        mines.add(3, 3, 999999, Image.MineSheet);
        mines.add(2, 5, 999999, Image.MineSheet);
        mines.add(0, 6, 999999, Image.MineSheet);
        mines.add(6, 0, 999999, Image.MineSheet);
        ...
        mines.add(3, 20, 999999, Image.MineSheet);
        mines.add(28, 20, 999999, Image.MineSheet);
        mines.add(15, 15, 999999, Image.MineSheet);
        mines.add(16, 14, 999999, Image.MineSheet);
        mines.add(17, 13, 999999, Image.MineSheet);
        mines.add(18, 12, 999999, Image.MineSheet);
        mines.add(19, 11, 999999, Image.MineSheet);
        mines.add(20, 10, 999999, Image.MineSheet);
        mines.add(21, 9, 999999, Image.MineSheet);
        mines.add(22, 8, 999999, Image.MineSheet);
        mines.add(23, 7, 999999, Image.MineSheet);
        mines.add(24, 6, 999999, Image.MineSheet);
        mines.add(25, 5, 999999, Image.MineSheet);
        mines.add(16, 15, 999999, Image.MineSheet);
        mines.add(17, 14, 999999, Image.MineSheet);
        mines.add(18, 13, 999999, Image.MineSheet);
        mines.add(19, 12, 999999, Image.MineSheet);
        mines.add(20, 11, 999999, Image.MineSheet);
        mines.add(21, 10, 999999, Image.MineSheet);
        mines.add(22, 9, 999999, Image.MineSheet);
        mines.add(23, 8, 999999, Image.MineSheet);
        mines.add(24, 7, 999999, Image.MineSheet);
        mines.add(25, 6, 999999, Image.MineSheet);
        mines.add(26, 5, 999999, Image.MineSheet);
        const result = astar.search(1, 1, 28, 28);
        if (DEBUG) astar.debugPrint();
        assert(result);
        const path = astar.test__getPath();
