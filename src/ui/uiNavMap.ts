...
export enum PauseMenuElement {
  ...
  ButtonWarpM1 = 'pauseButtonWarpM1',
  ButtonWarpM2 = 'pauseButtonWarpM2',
  ButtonWarpM3 = 'pauseButtonWarpM3',
  ButtonWarpPrompt = 'pauseButtonWarp9999',
...
const PAUSE_MENU_ELEMENT_ORDER: [
  ...
  [PauseMenuElement, PauseMenuElement, PauseMenuElement, PauseMenuElement, PauseMenuElement, PauseMenuElement],
  [PauseMenuElement, PauseMenuElement, PauseMenuElement, PauseMenuElement, PauseMenuElement, PauseMenuElement],
  [PauseMenuElement, PauseMenuElement, PauseMenuElement, PauseMenuElement],
  ...
  [PauseMenuElement, PauseMenuElement, PauseMenuElement, PauseMenuElement, PauseMenuElement],
    ...
    [
      PauseMenuElement.ButtonWarpM1,
      PauseMenuElement.ButtonWarpM2,
      PauseMenuElement.ButtonWarpM3,
      PauseMenuElement.ButtonWarpPrompt,
    ],
    [
